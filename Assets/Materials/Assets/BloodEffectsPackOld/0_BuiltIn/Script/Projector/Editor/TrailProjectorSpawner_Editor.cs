...
{
    [CustomEditor(typeof(BloodEffectsPack.TrailProjectorSpawner))]
    public class TrailProjectorSpawner_Editor : Editor
    {
        public override void OnInspectorGUI()
        {
            var spawner = (BloodEffectsPack.TrailProjectorSpawner)target;
