...
1. Read the documentation at folder '_FronkonGames/Glitches/Hacked/Documentation_' or visit the [online version](https://fronkongames.github.io/store/glitches/).
2. Open the scene at folder '_FronkonGames/Glitches/Hacked/Demo/_'.
